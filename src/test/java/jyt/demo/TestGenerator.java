...
//                .setOutputDir("F:\\workspacee\\jyt\\src\\main\\java")//设置输出路径
...
//        dataSourceConfig.setDriverName("oracle.jdbc.driver.OracleDriver").setUrl("jdbc:oracle:thin:@100")
//                .setUsername("mzhis").setPassword("mzhis");
//
//        //策略配置
...
//        packageConfig.setParent("com.ljh").setMapper("mapper")
