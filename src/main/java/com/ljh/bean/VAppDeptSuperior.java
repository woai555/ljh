 ...
 * @since 2020-10-26
 */
@JSONType(orders = {"sectname","sectid","importance","sectsummary","sectaddr","secttype","priority"})
public class VAppDeptSuperior implements Serializable {
