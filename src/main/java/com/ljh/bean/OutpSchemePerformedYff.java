 ...
 * @since 2020-10-26
 */
public class OutpSchemePerformedYff implements Serializable {
    ...
    public BigDecimal getOrderSubNo() {
        return orderSubNo;
    }

    public void setOrderSubNo(BigDecimal orderSubNo) {
