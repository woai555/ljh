 ...
 * @since 2020-10-26
 */
public class ViewHlhtPatientinfoupdate implements Serializable {
    ...
    private String homeCun;

    private String homeMph;
    ...
    public String getHomeMph() {
        return homeMph;
    }

    public void setHomeMph(String homeMph) {
        this.homeMph = homeMph;
    }
    ...
    public String getLinkRscode() {
        return linkRscode;
    }

    public void setLinkRscode(String linkRscode) {
        this.linkRscode = linkRscode;
    }
    ...
    public String toString() {
        return "ViewHlhtPatientinfoupdate{" +
        "cardNo=" + cardNo +
        ", operDate=" + operDate +
        ", idenno=" + idenno +
