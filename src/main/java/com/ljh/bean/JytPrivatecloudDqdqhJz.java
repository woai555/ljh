 ...
 * @since 2020-10-26
 */
public class JytPrivatecloudDqdqhJz implements Serializable {
    ...
    private String medicarePersonFee;

    private BigDecimal needDivide;
    ...
    public String getMedicarePersonFee() {
        return medicarePersonFee;
    }

    public void setMedicarePersonFee(String medicarePersonFee) {
        this.medicarePersonFee = medicarePersonFee;
    }

    public BigDecimal getNeedDivide() {
        return needDivide;
    }

    public void setNeedDivide(BigDecimal needDivide) {
