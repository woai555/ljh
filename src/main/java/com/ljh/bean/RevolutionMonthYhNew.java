 ...
 * @since 2020-10-26
 */
public class RevolutionMonthYhNew implements Serializable {
     ...
     * 月份日期
     */
    @TableId(value = "MONTHDATE", type = IdType.AUTO)
    ...
    private BigDecimal day54;

    private BigDecimal day55;
    ...
    public BigDecimal getDay54() {
        return day54;
    }

    public void setDay54(BigDecimal day54) {
        this.day54 = day54;
    }

    public BigDecimal getDay55() {
        return day55;
    }

    public void setDay55(BigDecimal day55) {
        this.day55 = day55;
    }

    @Override
    public String toString() {
        return "RevolutionMonthYhNew{" +
        "monthdate=" + monthdate +
        ", opertime=" + opertime +
        ", day1=" + day1 +
        ", day2=" + day2 +
