 ...
 * @since 2020-10-26
 */
public class ViewIfInprepay implements Serializable {
    ...
    private LocalDateTime cancelDtime;
    ...
    public LocalDateTime getCancelDtime() {
        return cancelDtime;
    }

    public void setCancelDtime(LocalDateTime cancelDtime) {
        this.cancelDtime = cancelDtime;
    }
