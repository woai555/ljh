 ...
 * @since 2020-10-26
 */
public class OrdRecipedetailBak implements Serializable {
    ...
    public LocalDateTime getTstime() {
        return tstime;
    }

    public void setTstime(LocalDateTime tstime) {
        this.tstime = tstime;
    }
