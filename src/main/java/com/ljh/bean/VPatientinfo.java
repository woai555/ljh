 ...
 * @since 2020-10-26
 */
public class VPatientinfo implements Serializable {
    ...
    public String getCardnoYb() {
        return cardnoYb;
    }

    public void setCardnoYb(String cardnoYb) {
        this.cardnoYb = cardnoYb;
    }
